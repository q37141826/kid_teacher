...
import cn.dajiahui.kidteacher.ui.homework.sendhomework.SendJudgeFragment;

import static cn.dajiahui.kidteacher.controller.Constant.JudgeAnswerView_margin;


/**
 * Created by majin on 2018/2/7.
 */

@SuppressLint("AppCompatCustomView")
public class SendJudgeAnswerView extends RelativeLayout {
    private Context context;
    private JudjeQuestionModle inbasebean;
    private int position;
    public String val;

    public SendJudgeAnswerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }


    public SendJudgeAnswerView(Context context, JudjeQuestionModle inbasebean, int position) {
        super(context);
