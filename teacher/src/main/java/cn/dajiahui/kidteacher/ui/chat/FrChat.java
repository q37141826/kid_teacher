...
import cn.dajiahui.kidteacher.ui.chat.db.InviteMessgeDao;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        errorView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (((String) errorText.getTag()).equals("1")) {
                    initProgressBar();
    ...
    private void loginHx() {
        ...
        EMClient.getInstance().login(beUser.getThird().getEasemob_username(), beUser.getThird().getEasemob_passwd(), new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                PreferenceManager.getInstance().setCurrentUserNick(beUser.getNickname());
