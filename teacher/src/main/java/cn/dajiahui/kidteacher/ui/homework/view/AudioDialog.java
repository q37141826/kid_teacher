...
//    private Button btnOne, btnTwo;// 两个按钮
    ...
    public AudioDialog(Context context) {
        this(context, com.fxtx.framework.R.layout.dialog_audio);
    }

    public AudioDialog(Context context, int layoutid) {
        super(context, com.fxtx.framework.R.style.transparentDialog);
        initWindow();
        initView(layoutid);
    }
    ...
    private void initView(int layout) {
        ...
        contentPanel = (LinearLayout) contextView
                .findViewById(com.fxtx.framework.R.id.contentPanel);
//        btnOne = (Button) contextView.findViewById(R.id.dialog_one);
//        btnTwo = (Button) contextView.findViewById(R.id.dialog_two);
        line = contextView.findViewById(com.fxtx.framework.R.id.dialog_line);
        tvTitle = (TextView) contextView.findViewById(com.fxtx.framework.R.id.title);
        tvMessage = (TextView) contextView.findViewById(com.fxtx.framework.R.id.message);
