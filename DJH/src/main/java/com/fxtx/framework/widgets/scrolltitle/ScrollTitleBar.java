...
public class ScrollTitleBar<T extends BeScorllTitle> extends HorizontalScrollView implements
	...
	public void setTitleView(List<T> titles,OnScrollTitleListener onScroll ,OnTitleView onTitleView) {
		this.title = titles;
	...
	public void setTitleView(List<T> titles,OnScrollTitleListener onScroll) {
